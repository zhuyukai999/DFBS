...
import gdut.edu.datingforballsports.view.activity.PublishPostActivity;
...
public class HomePageFragment extends Fragment implements View_ {
    ...
    public HomePageFragment newInstance(Context context,Intent intent){
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mHandler = new Handler(Looper.getMainLooper()) {
            ...
            public void handleMessage(Message message) {
                ...
                switch (message.what) {
                    case LOAD_FAILED:
                        Toast.makeText(context, RCmsg, Toast.LENGTH_LONG).show();
